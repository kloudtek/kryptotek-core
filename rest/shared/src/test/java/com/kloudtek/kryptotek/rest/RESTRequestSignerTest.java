...
public class RESTRequestSignerTest {
    public static final String NOUNCE = "e44fc2ca-460a-4e82-b88f-41dca6cdec19";
    ...
    public void testSigning() throws Exception {
        ...
        RESTRequestSigner requestSigner = new RESTRequestSigner("GET", "https://api.idvkey.com/someapi", NOUNCE, "2016-03-30T23:54:46", "somekeyid");
        ...
        RESTResponseSigner responseSigner = new RESTResponseSigner(NOUNCE, StringUtils.base64Encode(sig), 200);
